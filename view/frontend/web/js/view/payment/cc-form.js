...
define(
    [
        ...
        'PagarMe_PagarMe/js/model/credit-card-validation/credit-card-number-validator',
        'mage/translate'
    ],
    function (_, Component, creditCardData, cardNumberValidator, $t) {
        ...
        return Component.extend({
            ...
            initialize: function () {
                ...
                window.checkoutConfig.payment.pagarme_creditcard.brandIsValid = false;
                ...
                this.creditCardNumber.subscribe(function (value) {
                    ...
                    if(cardsAvailables[result.card.type]){
                        window.checkoutConfig.payment.pagarme_creditcard.brandIsValid = true;
                        return false;
                    }
            ...
            isSaveCardHave: function() {
                return window.checkoutConfig.payment.pagarme_creditcard.is_saved_card;
            },

            isSaveCardStyle: function() {
                if (window.checkoutConfig.payment.pagarme_creditcard.selected_card) {
                    return 'display: none;';
                }
            ...
            getCardsCustomer:function () {
                return _.map(window.checkoutConfig.payment.pagarme_creditcard.cards, function (value, key) {
                    return {
                        'value': value.id,
