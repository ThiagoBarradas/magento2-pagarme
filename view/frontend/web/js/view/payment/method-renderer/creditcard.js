...
define(
    [
        'PagarMe_PagarMe/js/view/payment/cc-form',
        'ko',
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'PagarMe_PagarMe/payment/creditcard',
                creditCardType: '',
            ...
            createAndSendTokenCreditCard: function (data, event) {
                ...
                var brandIsValid = window.checkoutConfig.payment.pagarme_creditcard.brandIsValid;
