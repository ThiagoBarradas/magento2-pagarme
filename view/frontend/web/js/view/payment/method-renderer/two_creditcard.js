...
define(
    [
        'PagarMe_PagarMe/js/view/payment/two-cc-form',
        'ko',
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'PagarMe_PagarMe/payment/two-creditcard',
            ...
            createAndSendTokenCreditCardFirst: function (data, event) {
                ...
                var firstBrandIsValid = window.checkoutConfig.payment.pagarme_two_creditcard.brandFirstCardIsValid;
                var secondBrandIsValid = window.checkoutConfig.payment.pagarme_two_creditcard.brandSecondCardIsValid;
