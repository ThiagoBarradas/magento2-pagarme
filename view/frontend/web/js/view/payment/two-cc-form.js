    ...
    function (_, Component, creditCardData, cardNumberValidator, $t) {
        ...
        return Component.extend({
            ...
            initialize: function () {
                ...
                window.checkoutConfig.payment.pagarme_two_creditcard.brandFirstCardIsValid = false;
                window.checkoutConfig.payment.pagarme_two_creditcard.brandSecondCardIsValid = false;
                ...
                this.creditCardNumberFirst.subscribe(function (value) {
                    ...
                    if(cardsAvailables[result.card.type]){
                        window.checkoutConfig.payment.pagarme_two_creditcard.brandFirstCardIsValid = true;
                        return false;
                    }
                ...
                this.creditCardNumberSecond.subscribe(function (value) {
                    ...
                    if(cardsAvailables[result.card.type]){
                        window.checkoutConfig.payment.pagarme_two_creditcard.brandSecondCardIsValid = true;
                        return false;
                    }
